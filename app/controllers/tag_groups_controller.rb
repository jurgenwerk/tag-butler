class TagGroupsController < ApplicationController
  ...
  def show
    @tag_group = TagGroup.find_by_slug(params[:id])
  ...
  def create
    ...
    @tag_group = current_user.tag_groups.new(params[:tag_group])

    respond_to do |format|
      if @tag_group.save
        format.html { redirect_to root_path, notice: 'Tag group was successfully created.' }
